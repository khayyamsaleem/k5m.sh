...
title = "a two-node homelab built on tailscale, docker compose, and stubbornness"
tags = ["ai-generated"]
draft = false
+++
...
## 🤖 How AI rebuilt the whole thing

I sat down with [Claude Code](https://claude.ai/claude-code) and rebuilt the entire configuration in a single session. Not "AI suggested some things and I implemented them" -- I mean Claude Code SSHed into both servers, tested changes live, debugged failures in real time, and iterated until everything worked.
